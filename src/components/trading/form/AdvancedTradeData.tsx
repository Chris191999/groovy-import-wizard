  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div>
          <Label htmlFor="trade_duration_hours">Trade Duration (Hours)</Label>
          <Input
            id="trade_duration_hours"
            type="number"
            step="0.1"
            value={formData.trade_duration_hours || ''}
            onChange={(e) => onFieldChange('trade_duration_hours', parseFloat(e.target.value))}
            placeholder="How long was the trade open"
          />
        </div>
      </div>
    </div>
