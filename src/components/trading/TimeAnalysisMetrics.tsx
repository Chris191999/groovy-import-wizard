        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-blue-500">
              {(durationStats.avgDuration || 0).toFixed(1)}h
            </div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-500">
              {(durationStats.medianDuration || 0).toFixed(1)}h
            </div>
            <p className="text-xs text-muted-foreground">
              Middle holding time
            </p>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-purple-500">
              {(durationStats.avgDuration || 0) > 0 
                ? (trades.reduce((sum, trade) => sum + (trade.pnl || 0), 0) / (durationStats.avgDuration || 1)).toFixed(0)
                : 0}
            </div>
            <p className="text-xs text-muted-foreground">
              P&L per hour
          ...
          <CardContent className="space-y-4">
              ...
              <div className="flex justify-between items-center p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                ...
                <div className="text-right">
                  <p className="font-bold text-green-700 dark:text-green-300">
                    {formatCurrency(timeAnalysis.hourlyPerformance.reduce((best, current) => 
                      current.pnl > best.pnl ? current : best
                    ).pnl)}
                  </p>
                </div>
            ...
            {timeAnalysis.dailyPerformance.length > 0 && (
              <div className="flex justify-between items-center p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                ...
                <div className="text-right">
                  <p className="font-bold text-green-700 dark:text-green-300">
                    {formatCurrency(timeAnalysis.dailyPerformance.reduce((best, current) => 
                      current.pnl > best.pnl ? current : best
                    ).pnl)}
                  </p>
                </div>
          ...
          <CardContent className="space-y-4">
              ...
              <div className="flex justify-between items-center p-3 bg-red-50 dark:bg-red-900/20 rounded-lg">
                ...
                <div className="text-right">
                  <p className="font-bold text-red-700 dark:text-red-300">
                    {formatCurrency(timeAnalysis.hourlyPerformance.reduce((worst, current) => 
                      current.pnl < worst.pnl ? current : worst
                    ).pnl)}
                  </p>
                </div>
            ...
            {timeAnalysis.dailyPerformance.length > 0 && (
              <div className="flex justify-between items-center p-3 bg-red-50 dark:bg-red-900/20 rounded-lg">
                ...
                <div className="text-right">
                  <p className="font-bold text-red-700 dark:text-red-300">
                    {formatCurrency(timeAnalysis.dailyPerformance.reduce((worst, current) => 
                      current.pnl < worst.pnl ? current : worst
                    ).pnl)}
                  </p>
                </div>
