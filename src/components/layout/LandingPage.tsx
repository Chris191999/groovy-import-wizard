...
import { Plane, ClipboardCheck, FileText, Package, Shield, Layers, Square } from 'lucide-react';
...
export const LandingPage: React.FC = React.memo(() => {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-x-hidden dark-tech-bg">
      ...
      <section className="relative z-10 min-h-screen flex flex-col items-center justify-center text-center px-4 sm:px-6 pt-20 sm:pt-24">
        ...
        >
          ...
          <p className="text-base sm:text-lg md:text-xl text-white/70 mb-6 sm:mb-12 font-medium max-w-2xl mx-auto leading-relaxed px-4">
      ...
      {/* Hero Section 2 - Mobile Optimized */}
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="glass-card p-6 sm:p-8">
            ...
            <div className="flex flex-col items-center gap-3 sm:gap-4">
              ...
              <div className="flex items-center gap-2 text-white/40 text-sm sm:text-base md:text-lg">
                <img src="/discord-server.png" alt="Discord" className="w-4 h-4 sm:w-5 sm:h-5 rounded-full opacity-60" />
      ...
      {/* Add shine animation for TRADEMIND text */}
      <style>
        {`
          @keyframes shine {
            0% {
